...
const texts = [
    "Bienvenido a Taostar Music",
    "Disfruta de paisajes anime relajantes y una experiencia visual musical",
    "Reproducción musical totalmente inmersiva",
    "Haz clic para ir a la página de descarga"
];
