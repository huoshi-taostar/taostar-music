    ...
    const video = document.getElementById('video-taostar-music');
    const playPauseBtn = document.getElementById('playPause-taostar-music');
    const muteUnmuteBtn = document.getElementById('muteUnmute-taostar-music');
    const fullscreenBtn = document.getElementById('fullscreen-taostar-music');
    const progress = document.getElementById('progress-taostar-music');
    const timeDisplay = document.getElementById('timeDisplay-taostar-music');
    const controls = document.getElementById('controls-taostar-music');
    const container = document.getElementById('container-taostar-music');
